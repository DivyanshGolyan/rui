...
server_cap=int(sys.argv[8]) if len(sys.argv)>8 else 1000
...
async def accept(reader,writer):
 ...
 h=H2Connection(H2Configuration(client_side=False));h.initiate_connection();h.update_settings({SettingCodes.MAX_CONCURRENT_STREAMS:server_cap})
