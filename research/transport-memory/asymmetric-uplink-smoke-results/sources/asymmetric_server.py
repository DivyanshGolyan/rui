...
async def accept(reader,writer):
 ...
 try:
  if proto==1:
   ...
   h=H2Connection(H2Configuration(client_side=False));h.initiate_connection();h.update_settings({SettingCodes.MAX_CONCURRENT_STREAMS:1000});h.increment_flow_control_window(16*1024*1024-65535)
...
async def main():
 ...
 emit(ready=True,ssl=ssl.OPENSSL_VERSION,h2_connection_receive_window=16777216,h2_stream_receive_window=65535)
