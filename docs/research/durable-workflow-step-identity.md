...
Subsequent decision: [#94 accepted explicit durable Session-call keys](https://github.com/DivyanshGolyan/onepage/issues/94#issuecomment-5568341325). The comparison and recommendations below preserve the research-stage discussion; the current [workflow contract](../../ARCHITECTURE.md#workflow-runs) owns the selected behavior.
