...
The [Matklad architecture experiments](../../research/matklad-experiments/README.md) add post-seal parsing, SQLite spill diagnosis, workspace lifetime, manifest representation, and recovery-fixture evidence. Their [publication notes](../../research/matklad-experiments/PUBLICATION.md) distinguish frozen contract snapshots and recorded measurements from current requirements.
