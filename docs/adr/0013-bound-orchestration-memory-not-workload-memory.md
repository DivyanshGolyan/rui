...
- a Dormant or closed Session and a Blocked Workflow Run retain no live Harness allocation, Active Credit, thread, socket, subprocess, JavaScript heap, or Promise graph; an In-flight Session retains only its one credit and bounded admitted-adapter resources, never a Harness or Slot;
