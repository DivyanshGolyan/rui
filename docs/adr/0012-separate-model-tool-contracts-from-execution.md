...
## Accepted context and rejection amendments — 8 September 2026

[ADR-0023](0023-preserve-provider-replay-without-silent-degradation.md) adds System Instructions to Conversation and permits bounded typed rejection/provenance rather than permanent full unsupported-output retention. [ADR-0026](0026-let-operations-own-current-execution-and-final-results.md) assigns accepted output and required final evidence to the Operation. These supersede the four-entry list and Completion-evidence wording below; tool data still grants no authority.
