...
Historical supporting records: [execution contract audit](../design/archive/execution-contract-audit-2026-09-06.md) and [execution model comparison](../design/archive/execution-model-comparison-2026-09-06.md). These preserve the alternatives preceding this decision.
