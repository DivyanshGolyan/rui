> Current status: [ADR-0027](../adr/0027-use-an-in-process-exact-edit-module.md) supersedes the Git helper design below with native in-process Edit. The earlier audit and probes remain historical evidence. Search-text/workspace and target-eligibility accounting still require alignment; no four-Edit cap is accepted.
