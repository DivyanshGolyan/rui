...
Each recovery reports a 128-byte journal and 1,528 bytes of fixed native control metadata. Every build asserts that the combined `Harness`, durable adapter, and JSC slot bridge remain at most 1,536 bytes.
