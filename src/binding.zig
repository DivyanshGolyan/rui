...
pub const StrictToolJsonV1 = Semantic("strict-tool-json-v1");
...
test "authoritative bindings use stable domain-separated SHA-256 vectors" {
    const values = [_]Sha256{
        ...
        hash(StrictToolJsonV1, "echo onepage").bytes,
    ...
    const expected = [_][]const u8{
        ...
        "6584656b65de90914551825bbb32e1229383c4b243a54d969e6e1bd007b27228",
    ...
    comptime {
        ...
        std.debug.assert(ModelContract != StrictToolJsonV1);
