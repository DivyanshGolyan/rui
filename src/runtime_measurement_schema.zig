...
pub const RuntimeResources = struct {
    harness_owner_bytes: u64,
    live_harnesses_after_workload: u64,
    active_credit_reservation_bytes: u64,
    active_credit_occupied_high_water: u64,
    semantic_validation_reservation_bytes: u64,
    semantic_validation_occupied_high_water_bytes: u64,
    patch_workspace_reservation_bytes: u64,
    patch_workspace_occupied_high_water_bytes: u64,
};
